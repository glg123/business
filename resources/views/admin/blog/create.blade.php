    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix">
                    <div class="pull-left">
                        <h4 class="text-blue h4">Add New Blog Post</h4>
                ...
                <form method="POST" action="{{ route('admin.blogs.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input name="blog_title" class="form-control" type="text" placeholder="blog post title" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input name="blog_create_by" class="form-control" type="text" placeholder="blog post create by" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>blog post image</label>
                        <input name="blog_image" type="file" class="form-control-file form-control height-auto" required>
                    </div>

            ...
            <div class="page-header">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 text-right">
                        <a class="btn btn-primary" href="{{route('admin.blogs.create')}}"><span class="">Create New</span></a>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                            <a class="dropdown-item" href="{{route('admin.blogs.edit',$blogItem->id)}}"><i class="dw dw-edit2"></i> Edit</a>
                                            <form method="POST" action="{{ route('admin.blogs.destroy',$blogItem->id) }}" enctype="multipart/form-data">
                                                @csrf

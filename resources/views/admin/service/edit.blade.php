                ...
                <form method="POST" action="{{ route('admin.services.update',$service->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input name="service_title" class="form-control" type="text" value="{{$service->service_title}}" placeholder="blog post title">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-10">
                            <input name="service_icon" class="form-control" type="text" value="{{$service->service_icon}}" placeholder="Service Icon">
                        </div>
                    </div>

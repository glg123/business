        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-12">
                <div class="header-content">
                    <h1>{{$settings->slider_title}}</h1>
                    <p>
                        {!! $settings->slider_description !!}
                    </p>
                    <div class="button">
                        <a href="{{$settings->slider_video_link}}"
            ...
            <div class="col-lg-6 col-md-12 col-12">
                <div class="header-image">
                    <img src="{{$settings->slider_image}}" alt="#" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-12">
                <div class="about-image-five">
                    ...
                    <img src="{{$settings->about_us_image}}" alt="about" />
                </div>
            </div>
            <div class="col-lg-6 col-12">
                <div class="about-five-content">
                    <h6 class="small-title text-lg">About Us</h6>
                    <h2 class="main-title fw-bold">{{$settings->about_us_title}}</h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="content">
                        <h6>Services</h6>
                        <h2 class="fw-bold">{{$settings->service_title}}</h2>
                        <p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-services">
                        <div class="service-icon">
                            <i class="{{$serviceItem->service_icon}}"></i>
                        </div>
                        <div class="service-content">
                            <h4>{{$serviceItem->service_title}}</h4>
                            <p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="content">
                        <h6>latest news</h6>
                        <h2 class="fw-bold">{{$settings->blog_title}}</h2>
                        <p>
            ...
            @foreach($blogs as $blogItem)
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-news">
                        <div class="image">
                            <a href="javascript:void(0)"><img class="thumb" src="{{$blogItem->blog_image}}" alt="Blog" /></a>
                            <div class="meta-details">
                                <img class="thumb" src="{{$blogItem->blog_image}}" alt="Author" />
                                <span>{{$blogItem->blog_create_by}}</span>
                            </div>
                        </div>
                        <div class="content-body">
                            <h4 class="title">
                                <a href="javascript:void(0)"> {{$blogItem->blog_title}} </a>
                            </h4>
                            <p>
            ...
            <div class="col-xl-8">
                <div class="contact-form-wrapper">
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <textarea name="body" id="message" placeholder="Type Message" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-6 col-12">
                        ...
                        <div class="footer-widget f-about">
                            <div class="logo">
                                <a href="{{route('home')}}">
                                    <img src="{{$settings->footer_logo}}" alt="#" class="img-fluid" />
                                </a>
                            </div>
                            <p class=" text-white">
